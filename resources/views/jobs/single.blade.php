    ...
    <section class="site-section">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="mb-5">
              <figure class="mb-5"><img src="{{ asset('assets/images/job_single_img_1.jpggit ') }}" alt="Image" class="img-fluid rounded"></figure>
          ...
          <div class="col-lg-4">
            <div class="bg-light p-3 border rounded mb-4">
              ...
              <ul class="list-unstyled pl-3 mb-0">
                ...
                <li class="mb-2"><strong class="text-black">Application Deadline:</strong>{{ $job->aplication_deadline }}  </li>
              </ul>
            </div>
