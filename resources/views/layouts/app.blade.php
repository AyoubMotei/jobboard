        ...
        <div class="row text-center">
          <div class="col-12">
            <p class="copyright"><small>
              ...
              <!-- Link back to AYOUB MOTEI can't be removed. Template is licensed under CC BY 3.0. -->
              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by AYOUB MOTEI. </a>
            <!-- Link back to AYOUB MOTEI can't be removed. Template is licensed under CC BY 3.0. --></small></p>
          </div>
        </div>
      </div>
    </footer>
